...
offline (backend/data/knowledge_graph/exports/semantic/semantic_event_quality.csv,
...
ground_truth/price_labels.py) so prediction_service.evaluate_model() has an honest,
non-circular ground truth to score against instead of the old
...
Run inside the backend container:
    ...
    python -m tools.import_kg_dataset
"""
import csv
import os
import sys
...
from ground_truth import price_labels  # noqa: E402

CSV_PATH = os.path.join(
    os.path.dirname(__file__), "..", "data", "knowledge_graph", "exports", "semantic", "semantic_event_quality.csv"
)
